...
public class MyMoveCardsAction extends AbstractGameAction {
    ...
    public MyMoveCardsAction(CardGroup destination, CardGroup source, List<AbstractCard> toMove, Consumer<List<AbstractCard>> callback) {
        this.p = AbstractDungeon.player;
        this.destination = destination;
        this.source = source;
        this.predicate = card -> true;
        this.callback = callback;
        this.isRandom = false;
