...
public class CommonPower extends AbstractDeathReaperPower implements PostPowerApplySubscriber {
    ...
    @Override
    public void receivePostPowerApplySubscriber(AbstractPower pw, AbstractCreature abstractCreature, AbstractCreature abstractCreature1) {
        if (pw.ID.equals(StrengthPower.POWER_ID)) {
            AbstractPlayer p = AbstractDungeon.player;
            this.addToBot(new ApplyPowerAction(p, p, new DexterityPower(p, 23)));
        }
    }
}
