package DeathReaper.characters;
...
public class TheDeathReaper extends CustomPlayer {
    ...
    public static final String[] orbTextures = {
            "DeathReaperResources/images/char/defaultCharacter/orb/layer1.png",
            "DeathReaperResources/images/char/defaultCharacter/orb/layer2.png",
            "DeathReaperResources/images/char/defaultCharacter/orb/layer3.png",
            "DeathReaperResources/images/char/defaultCharacter/orb/layer4.png",
            "DeathReaperResources/images/char/defaultCharacter/orb/layer5.png",
            "DeathReaperResources/images/char/defaultCharacter/orb/layer6.png",
            "DeathReaperResources/images/char/defaultCharacter/orb/layer1d.png",
            "DeathReaperResources/images/char/defaultCharacter/orb/layer2d.png",
            "DeathReaperResources/images/char/defaultCharacter/orb/layer3d.png",
            "DeathReaperResources/images/char/defaultCharacter/orb/layer4d.png",
            "DeathReaperResources/images/char/defaultCharacter/orb/layer5d.png",};

    // =============== /TEXTURES OF BIG ENERGY ORB/ ===============

    // =============== CHARACTER CLASS START =================

    public TheDeathReaper(String name, PlayerClass setClass) {
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        for (int i = 1; i <= 4; i++) retVal.add(Strike.ID);
        for (int i = 1; i <= 4; i++) retVal.add(Defend.ID);
        retVal.add(DeathReaper_Card.ID);
        retVal.add(ShadowCloak.ID);
    ...
    public AbstractPlayer newInstance() {
        return new TheDeathReaper(name, chosenClass);
    }
    ...
    public void render(SpriteBatch sb) {
        super.render(sb);
        pressureMeter.render(sb);
    }
    @Override
    public void update() {
        super.update();
        pressureMeter.update();
    }
    @Override
    ...
    public static void setMaxPressure(int amt) { pressureMeter.setMaxAmount(amt); }
    public static void addPressure(int amt) { pressureMeter.addAmount(amt); }
    public static void addMaxPressure(int amt) { pressureMeter.addMaxAmount(amt); }
    public static int getPressure() { return pressureMeter.amount; }
    public static int getMaxPressure() { return pressureMeter.maxAmount; }
    public static int getRealPressure() { return Math.min(pressureMeter.amount,pressureMeter.maxAmount); }
}
