...
import DeathReaper.cards.DefaultRareAttack;
import DeathReaper.util.TextureLoader;

public class RarePower extends AbstractDeathReaperPower {
    ...
    private static final Texture tex84 = TextureLoader.getTexture("DeathReaperResources/images/powers/placeholder_power84.png");
    private static final Texture tex32 = TextureLoader.getTexture("DeathReaperResources/images/powers/placeholder_power32.png");
