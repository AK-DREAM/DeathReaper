...
public class ShadowScythe extends AbstractDynamicCard {
    // TEXT DECLARATION

    public static final String ID = DeathReaperCore.makeID(ShadowScythe.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new MyExhumeAction(magicNumber, false, card->true, list -> {
            for (AbstractCard c : list) if (c.type == CardType.ATTACK)
